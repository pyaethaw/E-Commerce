...
<div class="container my-5">
	...
	<div class="col-md-8 offset-md-2 table-bordered">
		...
		<form method="post" action="${BASE_URL }UserController?action=registerForm" autocomplete="off">
			...
			<div class="row justify-content-between no-gutters mt-3">
				<a
					href="http://localhost:8080/E-Commerce/UserController?action=login">Already
					Member! Please Login Here</a>
